...
To use the t-test is must be assumed that the populations are normally distributed. Due to the central limit theorem the distribution of sample means will approach a Normal distribution as the sample size increases. The shape of the box plots suggests the data are approximately normally distributed but this could be further investigated, for example using q-q plots.